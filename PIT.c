...
void PIT_callback_init(PIT_timer_t pit, void(*handler)(void)) /*Callback for the PIT*/
{
	switch (pit)
	{
		case PIT_0:
...
void PIT1_IRQHandler(void) /** ISR of the PIT_1*/
{
	if(PIT_1_callback)
	{
		PIT_1_callback();
...
void PIT2_IRQHandler(void) /** ISR of the PIT_2*/
{
	if(PIT_2_callback)
	{
		PIT_2_callback();
...
void PIT3_IRQHandler(void) /** ISR of the PIT_3*/
{
	if(PIT_3_callback)
	{
		PIT_3_callback();
